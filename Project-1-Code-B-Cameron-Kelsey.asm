...
loop8:
bge $t7, 7, EXIT			# if t7 >= 7, then exit.
add $t7, $t7, 1				# increment counter t7 each time
beq $t7, 4, loop8			# if the counter is the value of 4, just go to the next value
beq $t7, 6, loop8			# if the counter is the value of 6, go to the next value.
...
sub $t8, $t8, $t7			# else, keep subtracting divisor from sum
